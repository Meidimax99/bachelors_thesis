...
- Functional Properties of VM Systems
-> Present ways to improve the shortcommings?
- General Shortcommings of the exception handler for MM design
- Context Switch
- General Shortcommings of a segmented design

Specific shortcomings of this implementation

Reasoning about Cost of the new VM system
Problems with gaining quantitative data

Qualitative Data -> Memory accesses
Actual accesses -> Theoretical Cost analysis

Optimization opportunities -> What accesses could still be removed?
