...
Every virtual memory system must realize a mapping from virtual addresses of each processes
...
Main differences are in the details of the implemented page table structure and in the way the software has to create the mappings. This freedom allows adjusting the virtual memory system to fit more specific use cases, as hardware-based systems are design to service a wide range of different applications \cite{jacob1998look}.
