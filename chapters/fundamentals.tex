...
The idea was to make to programms completely unaware of of the real, physical memory by providing
an abstraction layer called virtual memory.\\
With virtual memory, programs appear to have whole memory space of the machine at their disposal (flexibility) and
