...
% Replacement policy
%   MIPS -> Indexed writes
\paragraph{Replacement Strategies} A advantage of software-managed TLBs is, that the operating system can implement custom
...
\paragraph{Trapframe and Trampoline} xv6 pins to special pages to the top end of a processes address space: The trampoline and trapframe pages.
