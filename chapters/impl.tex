...
% Introductory section for qemu implementation
\section{QEMU}
...
The TLB Miss exception does not have to trigger in the same situations as the page fault exception, but rather
...
lookup addresses in the TLB using a fast path.\\ \todo{add: dynamically-generated tcg code can directly use the TLB structures}
