...
\textbf{Physical Memory Allocator} % Rewrite below version in new context
...
\textbf{\texttt{copyin() copyout()}} The copyin() and copyout() functions are used to copy data between
...
\textbf{Process Loading} % No page table creation, asid allocation, also no destruction, % Parsing elf directly into AS
